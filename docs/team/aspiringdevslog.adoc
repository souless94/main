...
include::../UserGuide.adoc[https://github.com/aspiringdevslog/main/blob/v1.4/docs/UserGuide.adoc#aspiringdevslog-start-01]

include::../UserGuide.adoc[aspiringdevslog-end-01]

include::../UserGuide.adoc[#aspiringdevslog-start-01]
...
include::../DeveloperGuide.adoc[tag=temp]
