...
*** Updated Manual Testing portion in Developer Guide
** Community
...
include::../DeveloperGuide.adoc[tag=manual-test]
include::../DeveloperGuide.adoc[tag=security-mechanism-use-case]
