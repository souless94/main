...
==== `find_group` *unexpected results; TODO: bug fix*
1. Find groups whose names contain any of the given keywords
.. Test case: `find_group ` +
Expected:
...
Expected: output list of all available time slots
...
Expected: output list of all available time slots with at least 1 person available; if any
...
`add_timetable 1` +
Expected: adds the timetable to person 1
...
.. Test case: `edit_timetable 1 day/wednesday timing/0900 m/` +
