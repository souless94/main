...
- <<viewing_help_code_help_code>>
- <<locating_group_by_name_code_find_group_code>>
- <<list_all_persons_of_a_group_code_view_group_code>>
- <<list_all_time_slots_of_a_group_at_which_everyone_is_available_code_view_slots_all_code>>
- <<list_all_time_slots_of_a_group_in_descending_order_of_availability_code_view_slots_ranked_code>>

- <<listing_all_persons_code_list_code>>
- <<finding_a_person_code_find_code>>
- <<selecting_a_person_code_select_code>>
