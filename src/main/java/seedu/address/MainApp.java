...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing NUS Hangs ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        try {
            ...
            if (!addressBookOptional.isPresent()) {
                logger.info("Data file not found. Will be starting with a sample NUS Hangs AddressBook");
            }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting NUS Hangs " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping NUS Hangs ] =============================");
        ui.stop();
        try {
