...
public class FindAddressCommand extends Command {
    ...
    public static final String COMMAND_WORD = "find_address";
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all persons whose address contain any of "
            ...
            + "Example: " + COMMAND_WORD + " Gardens Reservoir";

    private final NameContainsKeywordsPredicate<Person> predicate;

    public FindAddressCommand(NameContainsKeywordsPredicate<Person> predicate) {
