 ...
 */
public class ViewGroupEveryoneAvailableTimeslotCommand extends Command {

    public static final String COMMAND_WORD = "view_slots_everyone";
     ...
     */
    public ViewGroupEveryoneAvailableTimeslotCommand(Name groupName) {
