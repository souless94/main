 ...
 */
public class ViewGroupAvailableTimeslotCommandParser implements Parser<ViewGroupAvailableTimeslotCommand> {
    ...
    public ViewGroupAvailableTimeslotCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                    ViewGroupAvailableTimeslotCommand.MESSAGE_USAGE));
        }
